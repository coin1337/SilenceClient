...
public class EntityUtil implements Util {
   ...
   public static boolean isntValid(Entity entity, double range) {
      return entity == null || isDead(entity) || entity.equals(mc.field_71439_g) || entity instanceof EntityPlayer && OyVey.friendManager.isFriend(entity.func_70005_c_()) || mc.field_71439_g.func_70068_e(entity) > MathUtil.square(range);
   }
   ...
   public static Map<String, Integer> getTextRadarPlayers() {
      ...
      while(var5.hasNext()) {
         ...
         if (!player.func_82150_aj() && !player.func_70005_c_().equals(mc.field_71439_g.func_70005_c_())) {
            ...
            ((Map)output).put(healthSB.toString() + " " + (OyVey.friendManager.isFriend(player) ? ChatFormatting.AQUA : ChatFormatting.RED) + player.func_70005_c_() + " " + distanceSB.toString() + " Â§f0", (int)mc.field_71439_g.func_70032_d(player));
