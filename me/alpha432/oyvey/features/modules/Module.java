...
public class Module extends Feature {
   ...
   public void enable() {
      ...
      if ((Boolean)HUD.getInstance().notifyToggles.getValue()) {
         TextComponentString text = new TextComponentString(OyVey.commandManager.getClientMessage() + " " + ChatFormatting.WHITE + this.getDisplayName() + ChatFormatting.GREEN + " ON");
   ...
   public void disable() {
      ...
      if ((Boolean)HUD.getInstance().notifyToggles.getValue()) {
         TextComponentString text = new TextComponentString(OyVey.commandManager.getClientMessage() + " " + ChatFormatting.WHITE + this.getDisplayName() + ChatFormatting.RED + " OFF");
         mc.field_71456_v.func_146158_b().func_146234_a(text, 1);
      }
