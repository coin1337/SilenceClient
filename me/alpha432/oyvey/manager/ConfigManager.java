...
public class ConfigManager implements Util {
   ...
   public String config = "silence/config/";
   ...
   public void loadConfig(String name) {
      List<File> files = (List)Arrays.stream((Object[])Objects.requireNonNull((new File("silence")).listFiles())).filter(File::isDirectory).collect(Collectors.toList());
      if (files.contains(new File("silence/" + name + "/"))) {
         this.config = "silence/" + name + "/";
      } else {
         this.config = "silence/config/";
      }
   ...
   public boolean configExists(String name) {
      List<File> files = (List)Arrays.stream((Object[])Objects.requireNonNull((new File("silence")).listFiles())).filter(File::isDirectory).collect(Collectors.toList());
      return files.contains(new File("silence/" + name + "/"));
   }
   ...
   public void saveCurrentConfig() {
      File currentConfig = new File("silence/currentconfig.txt");
      ...
      try {
         ...
         if (currentConfig.exists()) {
            ...
            writer.write(tempConfig.replaceAll("silence", ""));
            writer.close();
         } else {
